...
- **Waszp**: non risulta presente nell'elenco `boatClass` dell'API World Sailing interrogata il 2026-09-23. Da gestire con fonte alternativa, probabilmente sito di classe WASZP.
