# Davide Di Maria rappresenterà l’Italia alla prima edizione dei World Abilitysport Beach Games di Mersin
...
- Data SportVela: 20 Ottobre 2025
- Link: https://sportvela.net/blog/2025/10/20/davide-di-maria-rappresentera-litalia-alla-prima-edizione-dei-world-abilitysport-beach-games-di-mersin/
- Categorie: News, Para Sailing, Vetrina

## Perche' tenerla

- Filoni: para/inclusione, media/storytelling
- Valore: aiuta a ricostruire contesto, narrativa, territori/circoli, risultati o iniziative collegate alla memoria FIV.

## Sintesi operativa

- Temi operativi: para/inclusione, media/storytelling.
- Angoli editoriali: inclusione/accessibilita' e valore istituzionale.
- Classi/discipline citate: Hansa, Para Sailing.
- Nomi, circoli o luoghi da valutare: Davide Di Maria, Italia, World Abilitysport Beach Games, Mersin Dal, Mersin, Comitato Paralimpico Nazionale, Turchia, World Abilitysport, Beach ParaVolley, Campionati del Mondo, Para Powerlifting, World Cup, Para AirBadminton, Adaptive Sepak Takraw.
- Numeri/date utili da verificare: 18, 25, 2025, 303, 100, 24.
