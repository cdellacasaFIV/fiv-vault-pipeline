# Il sistema IHC argomento di studio all’Università di Udine
...
- Data Federvela: 25 Aprile 2020
- Link: https://federvela.it/2020/04/25/il-sistema-ihc-argomento-di-studio-alluniversita-di-udine/
- Categorie: condivisa, Nazionale

## Perche' tenerla

- Filoni: risultati, olimpica, zone/circoli, formazione/scuola, media/comunicazione
- Valore: fonte federale primaria per ricostruire decisioni, eventi, risultati, territori, progetti e comunicazione FIV.

## Sintesi operativa

- Temi operativi: risultati, olimpica, zone/circoli, formazione/scuola, media/comunicazione.
- Angoli memoria: risultato/storico sportivo ufficiale da collegare a classifiche finali quando disponibili, territori, zone e circoli, classi olimpiche o alto livello.
- Classi/discipline citate: non isolate automaticamente.
- Nomi, circoli o luoghi da valutare: Università di Udine Il, Università di Udine Data, Università di Udine News, World Sailing In-House Certification, Veleria Olisails di Muggia, Dipartimento di Ingegneria La, Federazione Internazionale, World Sailing, ISAF, Scopo, Regole di Classe, Federazione Nazionale, Classe Velica, Tale.
- Numeri/date utili: 25, 2020, 2006, 9001, 2008, 2009, 2014, 4500, 2018, 3500.
