# VIA ALL’ASTA SPORTIVA WE RUN TOGETHER
...
- Data Federvela: 11 Giugno 2020
- Link: https://federvela.it/2020/06/11/via-allasta-sportiva-we-run-together/
- Categorie: condivisa, Nazionale
- Archiviato: 2026-08-23

## Perche' tenerla

- Filoni: risultati, giovanile, parasailing/inclusione, media/comunicazione
- Valore: fonte federale primaria per ricostruire decisioni, eventi, risultati, territori, progetti e comunicazione FIV.

## Sintesi operativa

- Temi operativi: risultati, giovanile, parasailing/inclusione, media/comunicazione.
- Angoli memoria: risultato/storico sportivo ufficiale da collegare a classifiche finali quando disponibili, sviluppo giovanile e vivaio FIV, inclusione, parasailing e valore istituzionale.
- Classi/discipline citate: non isolate automaticamente.
- Nomi, circoli o luoghi da valutare: VIA ALL’ASTA SPORTIVA WE, RUN TOGETHER VIA ALL’ASTA, SPORTIVA WE RUN TOGETHER, Data, RUN TOGETHER News, Brescia e di Bergamo, CharityStars, RUN TOGETHER Data, Specialized, Peter Sagan, Santo Padre, Papa Francesco, Francesco Totti, Federica Pellegrini.
- Numeri/date utili: 11, 2020, 8, 2016, 20, 10 giorni, 19.
