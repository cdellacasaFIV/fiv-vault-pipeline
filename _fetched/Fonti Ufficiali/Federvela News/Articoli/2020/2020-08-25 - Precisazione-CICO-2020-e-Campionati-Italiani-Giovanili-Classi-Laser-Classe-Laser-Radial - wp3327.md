# Precisazione CICO 2020 e Campionati Italiani Giovanili Classi Laser – Classe Laser Radial
...
- Link: https://federvela.it/2020/08/25/precisazione-cico-2020-e-campionati-italiani-giovanili-classi-laser-classe-laser-radial/
- Categorie: condivisa, Nazionale

## Perche' tenerla

- Filoni: olimpica, giovanile
- Valore: fonte federale primaria per ricostruire decisioni, eventi, risultati, territori, progetti e comunicazione FIV.

## Sintesi operativa

- Temi operativi: olimpica, giovanile.
- Angoli memoria: sviluppo giovanile e vivaio FIV, classi olimpiche o alto livello.
- Classi/discipline citate: non isolate automaticamente.
- Nomi, circoli o luoghi da valutare: Precisazione CICO, Campionati Italiani Giovanili Classi, Laser, Classe Laser Radial Precisazione, CICO, Classe Laser Radial Data, Classe Laser Radial News, La Federazione Italiana Vela, Classe Laser, Campionati Italiani Classi Olimpiche, Laser Radial.
- Numeri/date utili: 2020, 25.
