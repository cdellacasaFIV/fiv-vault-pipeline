# La vela approda in ospedale: un incontro speciale al Policlinico Gemelli di Roma
...
- Data Federvela: 25 Marzo 2025
- Link: https://federvela.it/2025/03/25/la-vela-approda-in-ospedale-un-incontro-speciale-al-policlinico-gemelli-di-roma/
- Categorie: condivisa, Nazionale

## Perche' tenerla

- Filoni: risultati, olimpica, istituzionale, zone/circoli
- Valore: fonte federale primaria per ricostruire decisioni, eventi, risultati, territori, progetti e comunicazione FIV.

## Sintesi operativa

- Temi operativi: risultati, olimpica, istituzionale, zone/circoli.
- Angoli memoria: risultato/storico sportivo ufficiale da collegare a classifiche finali quando disponibili, atto, accordo, governance o policy federale, territori, zone e circoli, classi olimpiche o alto livello.
- Classi/discipline citate: Nacra 17.
- Nomi, circoli o luoghi da valutare: Policlinico Gemelli di Roma, Data, Policlinico, Federazione Italiana Vela, Unità di Oncologia Pediatrica, La Campionessa Olimpica Caterina, Banti, Nacra, Olimpiadi di Tokyo, Parigi, Presidente, IV Zona, Federazione Italiana Vela Carlo, Cacioppo.
- Numeri/date utili: 25, 2025, 17, 2020, 2024, 2023, 1994.
