# La Federazione Italiana Vela lancia il concorso per il logo del Centenario
...
- Filoni: istituzionale, media/comunicazione
- Valore: fonte federale primaria per ricostruire decisioni, eventi, risultati, territori, progetti e comunicazione FIV.

## Sintesi operativa

- Temi operativi: istituzionale, media/comunicazione.
- Angoli memoria: atto, accordo, governance o policy federale.
- Classi/discipline citate: non isolate automaticamente.
- Nomi, circoli o luoghi da valutare: La Federazione Italiana Vela, Centenario La Federazione Italiana, Centenario Data, Centenario News, Centenario, Federazione Italiana Vela, L’obiettivo, Consiglio Federale, Centenario FIV, Questo, JavaScript, Bando.
- Numeri/date utili: 17, 2025, 2027, 100, 15, 2.000.
