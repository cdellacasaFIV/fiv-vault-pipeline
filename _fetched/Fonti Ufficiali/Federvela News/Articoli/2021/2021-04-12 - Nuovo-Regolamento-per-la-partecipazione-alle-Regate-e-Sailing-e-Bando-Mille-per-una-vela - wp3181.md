# Nuovo Regolamento per la partecipazione alle Regate e-Sailing e Bando “Mille per una vela”
...
- Data Federvela: 12 Aprile 2021
- Link: https://federvela.it/2021/04/12/nuovo-regolamento-per-la-partecipazione-alle-regate-e-sailing-e-bando-mille-per-una-vela/
- Categorie: condivisa, Nazionale
- Archiviato: 2026-08-22

## Perche' tenerla

- Filoni: istituzionale, zone/circoli
- Valore: fonte federale primaria per ricostruire decisioni, eventi, risultati, territori, progetti e comunicazione FIV.

## Sintesi operativa

- Temi operativi: istituzionale, zone/circoli.
- Angoli memoria: atto, accordo, governance o policy federale, territori, zone e circoli.
- Classi/discipline citate: non isolate automaticamente.
- Nomi, circoli o luoghi da valutare: Nuovo Regolamento, Regate, Sailing e Bando, Mille, Data, La Federazione Italiana Vela, Regolamento, Sailing, LINK Ivan Branciamore Consigliere, Federale, L’attuale, Regate Interzonali, Una Vela, Campionati Zonali.
- Numeri/date utili: 12, 2021, 2.0, 10, 1.2, 1.1, 4, 5, 23, 25.
