...
# NOTA (2026-08-24): vedi la stessa nota nello script SportVela gemello — i file indice
# "Per Anno"/"Per Tema" possono superare 250-300KB e diventano impossibili da sincronizzare
# in sicurezza sul vault Drive tramite l'agente conversazionale della routine. Li spezziamo
# in piu' file quando superano MAX_ROWS_PER_INDEX_FILE righe.
